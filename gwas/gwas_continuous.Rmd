...
## Prepare data
pathD <- paste("steps/rice_imputed", c(".bed", ".bim", ".fam"), sep = "")
...
names(phenotypes) <- c("id", "population", "PH", "sex")
```
...
save(genData, file = "steps/genData_continuous.RData")

### analysis
load("steps/genData_continuous.RData")
```
