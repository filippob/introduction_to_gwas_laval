---
title: "GWAS - continuous trait - kinship"
...
```{r, echo=TRUE}
snpMatrix <- read.table("../3.imputation/rice_imputed.raw", header = TRUE)
SNP_INFO <- read.table("../3.imputation/rice_imputed.map")
