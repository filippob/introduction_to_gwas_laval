...
phenotypes <- read.table(
  "~/Dropbox/cursos/laval2019/data/rice_phenotypes.txt", 
  header = TRUE)
genotypes <- read.table(
  "~/Dropbox/cursos/laval2019/GWAS/steps/rice_imputed.raw", 
  header = TRUE)
genotypes <- genotypes[,-c(1,3,4,5,6)]
# genotypes[,c(2,7)]

df <- merge(phenotypes, genotypes[,c(1,2)], by.x="id", by.y="IID")
names(df) <- c("id","population","PH","sex","snp")
```
...
phenotypes <- read.table(
  "~/Dropbox/cursos/laval2019/data/dogs_phenotypes.txt", 
  header = TRUE)
genotypes <- read.table(
  "~/Dropbox/cursos/laval2019/GWAS/steps/dogs_imputed.raw", 
  header = TRUE)
genotypes <- genotypes[,-c(1,3,4,5,6)]

df <- merge(phenotypes, genotypes[,c(1,25)], by.x="id", by.y="IID")
names(df) <- c("id","family","disease","sex","snp")
```
